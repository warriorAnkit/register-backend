...
const getTemplateWithSoftDeleteById = async (parent, args, ctx) => {
  ...
  try {
    ...
    const template = await TemplateModel.findByPk(id, {
      include: [
        { model: models.TableField, as: 'fields', paranoid: false }, // Include fields if needed
        { model: models.TemplateProperty, as: 'properties', paranoid: false }, // Include properties if needed
      ],
    });
...
module.exports = getTemplateWithSoftDeleteById;
